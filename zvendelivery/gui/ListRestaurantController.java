...
public class ListRestaurantController implements Initializable {
    ...
    @FXML
    private Label gui_italian;
    @FXML
    private Label gui_burger;
    @FXML
    private Label gui_chinese;
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        for (Restaurant rec : list) {
            ...
            if (rec.getCategorieRestaurant().equals("Italian") && rec.getStatus().equals("verified")) {
                italian += 1;
            }
            if (rec.getCategorieRestaurant().equals("Burgers") && rec.getStatus().equals("verified")) {
                burger += 1;
            }
            if (rec.getCategorieRestaurant().equals("chinese") && rec.getStatus().equals("verified")) {
                chienese += 1;
            }
            gui_chicken.setText("" + chicken + " Restaurants");
            gui_italian.setText("" + italian + " Restaurants");
             gui_burger.setText("" + burger + " Restaurants");
            gui_chinese.setText("" + chienese + " Restaurants");
