...
public class Restaurant {
    ...
    public Restaurant(int id,String nom, String description, String addresse, String cite, String heureOuverture, String categorieRestaurant, String heureFermeture, String gouvernorat, int codePostal, String imageRestaurant, String nomImage) {
        this.nom = nom;
        this.description = description;
        this.addresse = addresse;
        this.cite = cite;
