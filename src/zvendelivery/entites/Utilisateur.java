...
public class Utilisateur {
    private int id, etat,numtel,isVerified,isVerifiedemail;
      private String role,phonecode,createdAt,dateNaissance,image,nomimage,email,passowrd,nom,prenom,adresse,sexe,pseudo;

    public Utilisateur() {
    }
     public Utilisateur(int id,String email, String nom, String prenom,String pseudo,int etat) {
        this.email = email;
        this.nom = nom;
        this.prenom = prenom;
         this.id = id;
 ...
 public Utilisateur(int id,String email, String nom, String prenom,String pseudo,int numtel,String adresse) {
        this.email = email;
        this.nom = nom;
        this.prenom = prenom;
         this.id = id;
    ...
    public Utilisateur(String email, String nom, String prenom,int id,String adresse,int numtel,String password,String pseudo,String phonecode,int isVerified,String nomimage,int isVerifiedemail,int etat) {
        this.email = email;
        this.nom = nom;
        this.prenom = prenom;
         this.id = id;
