 ...
 * @author haith
 */
public class PhoneUserController implements Initializable {
    ...
    @FXML
    private void verifphone(ActionEvent event) throws NoSuchAlgorithmException {
        try {
            ...
            su.modiferetatphone(SessionManager.getId());
           SessionManager.setIs_verified_phone(1);
